...
const KidsPage = () => {
  const [products, setProducts] = useState(mockKidsProducts);
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Hero Banner */}
      <div className="h-60 bg-gradient-to-r from-green-500 to-teal-600 flex items-center justify-center text-white text-3xl font-bold">
        Kids’ Fashion
      </div>
      ...
      <div className="flex p-6 gap-6">
        ...
        <aside className="w-1/4 hidden md:block bg-white rounded-lg shadow p-4 h-fit">
          ...
          <div className="mb-6">
            ...
            {["All", "Tops", "Bottoms", "Footwear", "Dresses", "Outerwear"].map(
              (cat) => (
        ...
        <main className="flex-1">
          ...
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold">Kids’ Products</h1>
            <select
              value={sortOption}
